...
\newif\ifbibliography
\hypersetup{
            pdftitle={geotopbricks: An R Package for the Distributed Hydrological Model GEOtop},
...
\title{geotopbricks: An R Package for the Distributed Hydrological Model GEOtop}
