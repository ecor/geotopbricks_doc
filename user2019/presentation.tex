...
Github, see
\href{geotopmodel.github.io/geotop/}{http://geotopmodel.github.io/geotop/}
or \href{https://www.geotop.org}{www.geotop.org}, and it simulates:
\begincols
...
\item
  ...
  Equation)} : \emph{\emph{unkowns: soil liquid water content,soil water
  pressure head}};
\item
  heat flow in the soil \(\,\to\,\) \emph{(heat equation and frozen soil
  thermodynamics) } : \emph{\emph{unkowns: soil l temperature,soil ice
  (soild water) content (in case of frozen soil)}};
\item
  energy exchange with the atmosphere \(\,\to\,\) boundary conditions of
  the equations above : \_*unknowns : evapotranspiration, latent heat
  fluxes, radiation, snow depth and density
\end{itemize}
