...
- Some of us are resercher, other are self-employed and freelancers as www.rendena100.eu .  
- Some of us are author of several R-packages and R enthusiast. 
- Some of us are developers of GEOtop hydrologic models with skils in hydrology and environmental scinces but aloso in C/C++, parallell programming, HPC, etc
...
GEOtop is an open-source integrated hydrological model, available though Github,  see [http://geotopmodel.github.io/geotop/](geotopmodel.github.io/geotop/) or [www.geotop.org](https://www.geotop.org), and it simulates:
\begincols
...
- soil water flow in the soil (*Richards' equation,De Saint-Venant Equation)* : _*unkowns: soil liquid water content,soil water pressure head*_; 

- heat flow in the soil $\,\to\,$ *(heat equation and frozen soil thermodynamics) * : _*unkowns: soil l temperature,soil ice (soild water) content (in case of frozen soil)*_; 

- energy exchange with the atmosphere $\,\to\,$  boundary conditions of the equations above : _*unknowns : evapotranspiration, latent heat fluxes, radiation, snow depth and density 
...
- documented on GitHub repository: *http://geotopmodel.github.io/geotop/* and indexed in Zenodo : *https://zenodo.org/record/2560151#.XQtNZJxS8eM*
...
Here is an example on how to extract soil water content (SWC) at a 18cm depth in two sites P2 and B2, located in Val Mazia/Match, Malles Venosta/Mals Vinschgau, in South Tyrol, Italy (LOng Term Reasearch Ecological Area, [http://lter.eurac.edu/en]).
The goal of the code lines below is to represent the distribution of soil water content in August per different years (e.g. from 2010 to 2014)  
