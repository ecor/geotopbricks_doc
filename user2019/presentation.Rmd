...
\begincol{.48\textwidth}
 ...
 ![](resources/images/versante1.png){width=50%}\
 
 ![](resources/images/versante2.png){width=50%}\
...
- __Semplifica il grafico con solo input e output e processi principali__
...
- complexity in input/output/configuration files and data difficult to manage
...
- potential interactions between hydrology (GEOtop) and other knowledge domains (_discipines_).
...
## __geotopcks__ Application 1: Simulation of soil water budget in an alpine site
...
wpath_3D <- 'resources/simulation/Mazia'
